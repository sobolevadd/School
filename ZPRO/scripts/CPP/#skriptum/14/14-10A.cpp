// Soubor 14-10A.cpp
// Totez jako 14-10.cpp, ale trida GO je nyni
// abstraktni (metoda Nakresli() je ciste virtualni)
//
...
public:
	...
	virtual void Nakresli()=0;	// Ciste virtualni metoda
...
int main()
{
	...
	// GO g; // Chyba: nelze delat instance sbstraktni tridy
