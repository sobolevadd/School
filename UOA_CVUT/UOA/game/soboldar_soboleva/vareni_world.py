...
#P:/p1_EDU_Demo/game/a1j_whole/ck_world.py
"""
...
def initialize() -> None:
    ...
    _current_place = _NAME_2_PLACE['dům']
    # dbg.prSE(0, 0, 'world.initialize')


# @dbg.prSEdr('a1j_whole/ck_world')
...
_PLACES = (
    Place('Dům',
          'Domeček, ve kterém Honza bude vařit',
          ('Sklad', 'Ulice', 'Kuchyn', ),
          ('_Peníze', '#Dedecek', '_Plysak', '_Kniha', ),
         ),
    Place('Albert',
          MARKET,
          ('Ulice',  ),
          ('_Brambory', '_Okurky', '_Jahody', '_Kasa',),
         ),
    Place('Kuchyn',
          KITCHEN,
          ('Dům', 'Sklad',  ),
    ...
    Place('Sklad',
          'Sklad, kde Honza má všechny potraviny ',
          ('Dům', 'Kuchyn',),
          ('_Mlíko', '_Těstoviny', '_Cibule', ),
         ),
    Place('Ulice',
          STREET,
          ('Dům', 'Albert',),
